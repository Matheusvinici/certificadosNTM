                ...
                <form id="regForm" class="form-horizontal" method="POST" action="{{ route('certificado.store') }}">
                    ...
                    <div class="col">
                        ...
                        <select name="nome_responsavel" id="nome_responsavel" class="form-control">
                            ...
                            <option value="Superintendente de Formação">Superintendente de Formação: Clemilda Dias de Souza</option>
                            <option value="Diretor(a)">Diretor(a)</option>
                            <option value="Coordenador Geral do NTM - Reginaldo Medrado Dias">Coordenador Geral do NTM - Reginaldo Medrado Dias</option>
